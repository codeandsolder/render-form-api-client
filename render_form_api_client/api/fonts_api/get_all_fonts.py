    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[ApiError, list["FontItem"]]]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = FontItem.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiError, list["FontItem"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Returns all fonts available in the system for the current user.
